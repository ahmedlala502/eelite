...
STORIES = [
 ...
 ("A.O.K Kitchen","Saudi Arabia","40M","+309","Restaurant",2),
 ("Enigmaku","Kuwait","24.9M","+186","Fashion",3),
 ("tabl.to","Saudi Arabia","19.7M","+360","",4),
 ("Tashas Cafe","Saudi Arabia","17.9M","+87","Cafe",1),
 ("Iris","Saudi Arabia","17M","+125","Restaurant",2),
 ("Clap","Saudi Arabia","17M","+120","Restaurant",3),
 ("Brute","Saudi Arabia","15M","+93","Restaurant",4),
 ("Lavenue","Saudi Arabia","15M","+89","Restaurant",1),
 ("Beit El Sabban","Saudi Arabia","13.9M","+58","Restaurant",2),
 ("Urth Caffe","Saudi Arabia","12M","+134","Cafe",3),
 ("Jones the Grocer","Saudi Arabia","12M","+118","Cafe",4),
 ("Maryool","Kuwait","9M","+11","Restaurant",1),
 ("Swaikhat & Tanoor","Kuwait","7M","+10","Restaurant",2),
 ("Signor Sassi","Saudi Arabia","5M","+7","Restaurant",3),
 ("MYAZŪ","Saudi Arabia","5M","+6","Restaurant",4),
 ("ROBATA","Saudi Arabia","5M","+5","Restaurant",1),
 ("Agio","Saudi Arabia","4M","+3","Restaurant",2),
 ("Coya","Saudi Arabia","3M","+3","Restaurant",3),
 ("Kiko","Saudi Arabia","2.1M","+1","Beauty",4),
 ("Million Riyal Menu","Saudi Arabia","571.5K","+8","",1),
 ("Panerai","Saudi Arabia","536.1K","+1","Fashion",2),
 ("Fred","Saudi Arabia","206.2K","+1","Fashion",3),
 ("Rituals Cosmetics","Saudi Arabia","98.5K","+2","",4),
]

def story_grid():
    return "".join(f"""
      <a class="story reveal" data-delay="{i}" data-cat="{cat}" data-name="{n}" href="#story-{i}" aria-label="{n} — success story">
        <div class="story__media"><div class="art art--{a}"></div></div>
        <span class="story__play" aria-hidden="true">{ICONS['play']}</span>
        <div class="story__meta">
          <span class="name">{n}</span><span class="place">{p}</span>
          <div class="story__stats">
            <div>Followers<b>{f}</b></div><div>Influencers<b>{inf}</b></div>
          </div>
        </div>
      </a>""" for i,(n,p,f,inf,cat,a) in enumerate(STORIES, start=1))
